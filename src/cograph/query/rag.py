...
from cograph.query.cypher_qa import get_cypher_retriever
from cograph.query.prompts import RAG_PROMPT_TEMPLATE, RAG_SYSTEM_PROMPT
from cograph.query.retriever import get_vector_cypher_retriever
...
def interactive() -> None:
    ...
    print("CoGraph Query Layer — type 'quit' to exit.\n")
    while True:
        try:
