...
from crtkb.eval.judge import judge_answer
from crtkb.eval.metrics import compute_citation_accuracy, compute_graph_coverage
from crtkb.query.rag import query
...
def print_results_table(summary: dict) -> None:
    ...
    print("\n" + "=" * 80)
    print("CRTKB EVALUATION RESULTS")
    print("=" * 80)
